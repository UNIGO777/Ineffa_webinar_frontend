...
const PaymentSuccess = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white  flex flex-col relative overflow-hidden">
      {/* Confetti container */}
      ...
      >
        ...
        >
          <div className="absolute -inset-4 rounded-full bg-black/10 animate-pulse"></div>
        ...
        >
          <motion.button 
            onClick={() => navigate('/')} 
            className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-black/60 hover:bg-black/70 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black/500 transition-all duration-300"
